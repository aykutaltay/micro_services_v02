...
namespace micro_services_dal.Models.zoradamlar_com_db_mic_user
{
    public class info_useractivation
    {
        ...
        public string useractivation_useractivation_active = "useractivation_active";
        public string useractivation_useractivation_use = "useractivation_use";
        public string useractivation_tablename = "useractivation";
    }
